    ...
    def __init__(
        ...
        Args:
            ...
            log_dir: Directory for run logs. "auto" (default) creates
                /tmp/long_tamp/<task_slug>_<YYYYMMDD_HHMMSS>/;
        ...
        if log_dir is not None:
            try:
                ...
                from long_tamp.logging import RunLogger
